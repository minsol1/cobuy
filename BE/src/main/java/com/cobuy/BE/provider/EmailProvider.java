...
public class EmailProvider {
    ...
    private final String SUBJECT = "[임대주택 가격 서비스] 인증 메일입니다.";
    ...
    private String getCertificationMessage(String certificationNumber) {
        ...
        certificationMessage += "    <h1 style='text-align: center; color: #333333;'>[CoBuy 공동 구매 플랫폼 서비스]</h1>";
